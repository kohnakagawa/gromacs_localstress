...
void nb_kernel134(
                    ...
                    real *          work)
{
    gmxLS_locals_grid_t * locals_grid = (gmxLS_locals_grid_t *)work;
        ...
        for(n=nn0; (n<nn1); n++)
        {
            ...
            for(k=nj0; (k<nj1); k++)
            {
                ...
                if ((locals_grid->contrib == enAll) || (locals_grid->contrib == enVdw) || (locals_grid->contrib == enCoul))
                {
                    ...
                    //printf("Kernel134\n");
                    gmxLS_distribute_stress(locals_grid, 2, lpatIDs, lpR, lpF);
                }
                /* end stress tensor */
                ...
                {
                    lpR[0][0] = ix2; lpR[0][1] = iy2; lpR[0][2] = iz2; 
                    lpR[1][0] = jx4; lpR[1][1] = jy4; lpR[1][2] = jz4; 
                    lpatIDs[0] = ii+1; lpatIDs[1] = jnr+3;
                    lpF[0][0] = tx;  lpF[0][1] = ty;  lpF[0][2] = tz;
                    lpF[1][0] = -tx; lpF[1][1] = -ty; lpF[1][2] = -tz;
                    gmxLS_distribute_stress(locals_grid, 2, lpatIDs, lpR, lpF);
                }
                ...
                if ((locals_grid->contrib == enAll) || (locals_grid->contrib == enVdw) || (locals_grid->contrib == enCoul))
                {
                    ...
                    lpR[1][0] = jx2; lpR[1][1] = jy2; lpR[1][2] = jz2; 
                    lpatIDs[0] = ii+2; lpatIDs[1] = jnr+1;
                    lpF[0][0] = tx;  lpF[0][1] = ty;  lpF[0][2] = tz;
                    lpF[1][0] = -tx; lpF[1][1] = -ty; lpF[1][2] = -tz;
                    gmxLS_distribute_stress(locals_grid, 2, lpatIDs, lpR, lpF);
                }
                ...
                if ((locals_grid->contrib == enAll) || (locals_grid->contrib == enVdw) || (locals_grid->contrib == enCoul))
                {
                    lpR[0][0] = ix3; lpR[0][1] = iy3; lpR[0][2] = iz3; 
                    lpR[1][0] = jx3; lpR[1][1] = jy3; lpR[1][2] = jz3; 
                    lpatIDs[0] = ii+2; lpatIDs[1] = jnr+2;
                    lpF[0][0] = tx;  lpF[0][1] = ty;  lpF[0][2] = tz;
                    lpF[1][0] = -tx; lpF[1][1] = -ty; lpF[1][2] = -tz;
                    gmxLS_distribute_stress(locals_grid, 2, lpatIDs, lpR, lpF);
                }
                ...
                if ((locals_grid->contrib == enAll) || (locals_grid->contrib == enVdw) || (locals_grid->contrib == enCoul))
                {
                    lpR[0][0] = ix3; lpR[0][1] = iy3; lpR[0][2] = iz3; 
                    lpR[1][0] = jx4; lpR[1][1] = jy4; lpR[1][2] = jz4; 
                    lpatIDs[0] = ii+2; lpatIDs[1] = jnr+3;
                    lpF[0][0] = tx;  lpF[0][1] = ty;  lpF[0][2] = tz;
                    lpF[1][0] = -tx; lpF[1][1] = -ty; lpF[1][2] = -tz;
                    gmxLS_distribute_stress(locals_grid, 2, lpatIDs, lpR, lpF);
                }
                ...
                if ((locals_grid->contrib == enAll) || (locals_grid->contrib == enVdw) || (locals_grid->contrib == enCoul))
                {
                    lpR[0][0] = ix4; lpR[0][1] = iy4; lpR[0][2] = iz4; 
                    lpR[1][0] = jx2; lpR[1][1] = jy2; lpR[1][2] = jz2; 
                    lpatIDs[0] = ii+3; lpatIDs[1] = jnr+1;
                    lpF[0][0] = tx;  lpF[0][1] = ty;  lpF[0][2] = tz;
                    lpF[1][0] = -tx; lpF[1][1] = -ty; lpF[1][2] = -tz;
                    gmxLS_distribute_stress(locals_grid, 2, lpatIDs, lpR, lpF);
                }
                ...
                if ((locals_grid->contrib == enAll) || (locals_grid->contrib == enVdw) || (locals_grid->contrib == enCoul))
                {
                    lpR[0][0] = ix4; lpR[0][1] = iy4; lpR[0][2] = iz4; 
                    lpR[1][0] = jx3; lpR[1][1] = jy3; lpR[1][2] = jz3; 
                    lpatIDs[0] = ii+3; lpatIDs[1] = jnr+2;
                    lpF[0][0] = tx;  lpF[0][1] = ty;  lpF[0][2] = tz;
                    lpF[1][0] = -tx; lpF[1][1] = -ty; lpF[1][2] = -tz;
                    gmxLS_distribute_stress(locals_grid, 2, lpatIDs, lpR, lpF);
                }
                ...
                if ((locals_grid->contrib == enAll) || (locals_grid->contrib == enVdw) || (locals_grid->contrib == enCoul))
                {
                    lpR[0][0] = ix4; lpR[0][1] = iy4; lpR[0][2] = iz4; 
                    lpR[1][0] = jx4; lpR[1][1] = jy4; lpR[1][2] = jz4; 
                    lpatIDs[0] = ii+3; lpatIDs[1] = jnr+3;
                    lpF[0][0] = tx;  lpF[0][1] = ty;  lpF[0][2] = tz;
                    lpF[1][0] = -tx; lpF[1][1] = -ty; lpF[1][2] = -tz;
                    gmxLS_distribute_stress(locals_grid, 2, lpatIDs, lpR, lpF);
                }
