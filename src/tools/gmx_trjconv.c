...
static void center_x(int ecenter,rvec x[],matrix box,int n,int nc,atom_id ci[],t_atom atom[])
{
    int i,d,ai;
    rvec box_center,dx;
    dvec com;
		      ...
		      gmx_rmpbc_trxfr(gpbc,&fr);
                ...
                if (bWriteFrame) {
			      ...
			      gmx_rmpbc_trxfr(gpbc,&fr);
                            ...
                            if (bCenter)
                                /*put_molecule_com_in_box(unitcell_enum,ecenter,&top.mols,
                                                    natoms,atoms->atom,ePBC,fr.box,fr.x);*/
                                center_x(ecenter,fr.x,fr.box,natoms,ncent,cindex,atoms->atom);
                        }
