...
static void mdrunner_start_fn(void *arg)
{
    ...
    mda->ret=mdrunner(cr->nnodes, fplog, cr, mc.nfile, fnm, mc.oenv, 
                      ...
                      mc.cpt_period, mc.max_hours, mc.deviceOptions, mc.localsgridspacing, mc.nstlocals, 
                      mc.localsgridx, mc.localsgridy, mc.localsgridz, mc.localscontrib, mc.localsfdecomp, mc.localsspatialatom, mc.Flags);
}
