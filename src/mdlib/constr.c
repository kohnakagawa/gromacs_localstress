...
gmx_bool constrain(FILE *fplog,gmx_bool bLog,gmx_bool bEner,
               ...
               rvec *v,tensor *vir,
               t_nrnb *nrnb,int econq,gmx_bool bPscal,real veta, real vetanew,gmxLS_locals_grid_t *locals_grid)
{
    gmx_bool    bOK,bDump;
    ...
    if (constr->lincsd)
    {
        bOK = constrain_lincs(fplog,bLog,bEner,ir,step,constr->lincsd,md,cr,
                              ...
                              econq,nrnb,
                              constr->maxwarn,&constr->warncount_lincs,locals_grid);
    ...
    if (settle->nr > 0)
    {
        ...
        case econqCoord:
            csettle(constr->settled,
                    ...
                    invdt,v[0],vir!=NULL,rmdr,&error,&vetavar,locals_grid);
