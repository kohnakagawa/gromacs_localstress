...
void do_constrain_first(FILE *log,gmx_constr_t constr,
			       ...
			       t_forcerec *fr, gmx_localtop_t *top, tensor shake_vir,gmxLS_locals_grid_t *locals_grid);
...
int mdrunner(int nthreads_requested, FILE *fplog,t_commrec *cr,int nfile,
	     ...
	     const char *deviceOptions, real localsgridspacing, int nstlocals, 
	     int localsgridx, int localsgridy, int localsgridz, int localscontrib, int localsfdecomp, int localsspatialatom, unsigned long Flags);
